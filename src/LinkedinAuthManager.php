...
/**
 * Contains all Simple FB Connect logic that is related to Linkedin interaction.
 */
class LinkedinAuthManager extends OAuth2Manager {
   ...
   */
  public function __construct(LoggerChannelFactoryInterface $logger_factory, EventDispatcherInterface $event_dispatcher, EntityFieldManagerInterface $entity_field_manager, UrlGeneratorInterface $url_generator, LinkedinAuthPersistentDataHandler $persistent_data_handler) {
